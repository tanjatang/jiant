...
EP_RESOURCE_DIR="/home/itcast/jiant-v1-legacy/jiant/share/edge-probing/resources"
...
function elmo_chars_exp() {
    ...
    run_exp "/home/itcast/jiant-v1-legacy/jiant/config/edgeprobe/edgeprobe_bare.conf" "${OVERRIDES}"
}
...
function train_chars_exp() {
    ...
    run_exp "/home/itcast/jiant-v1-legacy/jiant/config/edgeprobe/edgeprobe_train.conf" "${OVERRIDES}"
}
...
function glove_exp() {
    ...
    run_exp "/home/itcast/jiant-v1-legacy/jiant/config/edgeprobe/edgeprobe_glove.conf" "${OVERRIDES}"
}
...
function cove_exp() {
    ...
    OVERRIDES+=", target_tasks=$1"
    run_exp "/home/itcast/jiant-v1-legacy/jiant/config/edgeprobe/edgeprobe_cove.conf" "${OVERRIDES}"
}
...
function openai_exp() {
    ...
    OVERRIDES+=", target_tasks=$1"
    run_exp "/home/itcast/jiant-v1-legacy/jiant/config/edgeprobe/edgeprobe_openai.conf" "${OVERRIDES}"
}
...
function bert_cat_exp() {
    ...
    run_exp "/home/itcast/jiant-v1-legacy/jiant/config/edgeprobe/edgeprobe_bert.conf" "${OVERRIDES}"
}
